...
int presolve_phase_1 = 1; // Set to 1 to turn on presolve phase 1. Otherwise, set to 0.
...
int show_progress = 1; // If this parameter is set to 1, BB progress is printed to the screen in a similar fashion to CPLEX's output for single objective MIPs. Each
...
int duality_fixing = 1; // If set to 0 the check for duality fixing during presolve will be turned off.
